...
- Student/teacher processors map subjects/teachers/rooms/periods, group events, apply include/exclude and optional day-end-hour filters from `config.yaml`, render HTML via Jinja, PDF via WeasyPrint, and per-page PNGs via PyMuPDF.
